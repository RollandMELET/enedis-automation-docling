...
# Description: Script pour envoyer un PDF à l'API Docling locale ou publique et afficher la sortie JSON.
#              Mis à jour pour tester l'API Docling déployée sur Coolify.
